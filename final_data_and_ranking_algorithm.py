...
def compute_ranking(static_merged_data, cost_of_living_data, user_input):
    ...
    df.to_excel(os.path.join(script_dir, "./static/gold/final_data_rank.xlsx"))
    ...
    # Exports ranked data to excel 
    df.to_excel('./static/gold/final_data_rank.xlsx')
    # print()

    # Comment this out for real use
    df.to_excel(os.path.join(script_dir, "./staic/gold/final_data_rank.xlsx"))
